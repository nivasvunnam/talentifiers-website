...
function ArchitectureMap() {
  ...
  const platformTech = [
    { label: 'Java', image: '/tech-icons/java.png' },
    { label: 'Docker', image: '/tech-icons/docker.png' },
    { label: 'Kubernetes', image: '/tech-icons/kubernetes.png' },
    { label: 'SQL', image: '/tech-icons/sql.png' },
    { label: 'Power BI', image: '/tech-icons/power-bi.png' },
    { label: 'GitHub Actions', image: '/tech-icons/github-actions.png' },
    { label: 'Playwright', image: '/tech-icons/playwright.png' },
    { label: 'WCAG', image: '/tech-icons/wcag.png' },
  ];
                ...
                .concat([
                  {
                    ...
                    items: [
                      { label: 'Manual verification', mark: 'MV', image: '/tech-icons/manual-verification.png' },
                      { label: 'Automation support', mark: 'AS', image: '/tech-icons/automation-support.png' },
                      { label: 'CI-friendly testing', mark: 'CI', image: '/tech-icons/ci-friendly-testing.png' },
                    ],
                  },
                ])
                .map((item) => (
